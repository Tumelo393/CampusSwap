...
function triggerVerification() {
  ...
  console.log(`[CampusSwap Demo] Verification code for ${email}: ${pendingTokenCode}`);
  // ────────────────────────────────────────────────────────
...
function resendCode() {
  ...
  pendingTokenCode = generateCode();
  console.log(`[CampusSwap Demo] Resent code for ${pendingSignup.email}: ${pendingTokenCode}`);
